# Based on: https://github.com/HurricaneLabs/filtration, modified for specific application
...
from pyparsing import CaselessLiteral, Group, Keyword, Literal, MatchFirst, OneOrMore
...
Symbol = Word((alphas + nums + "@" + "#" + "&"), bodyChars=(alphas + nums + "." + "_")).set_parse_action(_Symbol)
...
List = Suppress("[") + Group(Value + OneOrMore(Suppress(Literal(",")) + Value)).set_parse_action(_List) + Suppress("]")
